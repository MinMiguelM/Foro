...
INSERT INTO TOPIC(ID,CONTENT,DATE,POINTS,TITLE,APPROVED,ID_FORUM,ID_USER) VALUES (1,'The Gman spoke in a peculiar way, but seeing the tech in action 13 years ago was very impressive. To me, at least!In the same year we had Vampire Bloodlines.',CURRENT_DATE,1337,'A recent history of facial animation',0,2,4)
